            ...
            <div className="d-flex text-white flex-column flex-sm-row">
                <div className="d-flex flex-column mb-3">
                    ...
                    <div className="d-flex align-items-center">
                        <FaFacebookSquare className="fs-2 me-3"></FaFacebookSquare><a href="https://www.facebook.com" target="_blank" rel="noreferrer" className='text-decoration-none text-white'>Bldonor</a>
                    </div>
                ...
                <div className="w-100 mx-sm-5 mx-0">
                    <h3>About</h3>
                    <hr />
                    <p><BiRightArrow></BiRightArrow> <span>Connect</span></p>
                    <p><BiRightArrow></BiRightArrow> <span>FAQ</span></p>
                </div>
                <div className="w-100 mx-sm-5 mx-0">
                    <h3>General</h3>
                    <hr />
