            ...
            <div className="login-container">
                ...
                <form onSubmit={handleSignUp}>
                    <div className="form-outline mb-4">
                        ...
                        <input type="text" id="form2Example1" className="form-control" placeholder="Enter your username" onChange={(e) => setUserName(e.target.value)} required style={{ backgroundColor: '#F5F5F5' }} />
                    </div>
                    <div className="form-outline mb-4">
                    ...
                    <button type="submit" className="btn btn-dark  btn-block d-block mb-4 mx-auto py-3 my-3 px-5">Sign Up</button>
